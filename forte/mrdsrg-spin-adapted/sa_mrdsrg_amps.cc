...
void SA_MRDSRG::update_t2() {
    ...
    auto Hbar2copy = BlockedTensor::build(tensor_type_, "Hbar2 active copy", {"gggg"});
    Hbar2copy["pqrs"] = Hbar2_["pqrs"];
    ...
    Hbar2_["pqrs"] = Hbar2copy["pqrs"];
}

void SA_MRDSRG::update_t1() {
    // make a copy of the active part of Hbar2 as it will be used as intermediate
    auto Hbar1copy = BlockedTensor::build(tensor_type_, "Hbar1 active copy", {"gg"});
    Hbar1copy["pq"] = Hbar1_["pq"];
