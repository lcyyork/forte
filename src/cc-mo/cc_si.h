...
class CC_SI : public DynamicCorrelationSolver {
  public:
    // => Constructors <= //

    CC_SI(RDMs rdms, std::shared_ptr<SCFInfo> scf_info, std::shared_ptr<ForteOptions> options,
  ...
  protected:
    ...
    std::vector<double> Fd_a_;
    std::vector<double> Fd_b_;
